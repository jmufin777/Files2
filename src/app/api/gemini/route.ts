...
export async function POST(request: Request) {
  ...
  try {
    ...
    const accessInstruction = `\n\nYou have access ONLY to the provided Context text from local files. Do NOT claim you cannot access local files. If the context is missing or insufficient, ask the user to add the relevant files to context.`;
